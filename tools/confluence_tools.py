...
# Prompt for creating this function was: Write a function for showing a confluence page comparison in the default web browser like this: "show_confluence_version_comparison(page_id: str, version_1: int, version_2: int)". The version parameters are the respective version numbers.
...
# Prompt for creating this function was: Write a function for accessing the confluence search endpoint, including the ability to perform CQL queries
