...
#AI! Create a new tool "interactively_complete_description" with the issue_key as parameter and a boolean result. This tool interviews the user to iteratively complete the description according the the pib.rocks standard
